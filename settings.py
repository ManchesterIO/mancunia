...
APPLICATIONS = [
    ...
    # This app is desirable for mancunia.mobi - need to make library app multi
    # provider before we can use this, and also talk with council about getting
    # access to Z39.50 catalogues (http://issues.mollyproject.org/browse/MOLLY-179)
    ...
    Application('molly.apps.transport', 'transport', 'Transport',
        ...
        # ^^^ Disabled until we get an NRE token
        ...
        # Need to see if there's any automated system we can scrape with TfGM's
        # permission. http://www.metrolink.co.uk/todaysdisruptions/index.asp?id=7
        # isn't very scrapable
    ),
